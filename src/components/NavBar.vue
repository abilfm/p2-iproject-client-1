<template>
  ...
  <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
    <div class="container-fluid">
      <a @click.prevent="changePage('HomePage')" href="#" class="navbar-brand">BLOG WEBSITE</a>
      ...
      <div class="collapse navbar-collapse" id="res_nav">
        <ul class="navbar-nav me-auto">
          ...
          <li v-if="isLogin" class="nav-item">
            <a @click.prevent="changePage('HomePage')" href="#" class="nav-link">Home</a>
          </li>
          <li v-if="isLogin" class="nav-item">
            <a @click.prevent="changePage('FavouritesPage')" href="#" class="nav-link">Favourites</a>
          </li>
          <li v-if="isLogin" class="nav-item">
